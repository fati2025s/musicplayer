...
class BlackUserProfileScreen extends StatefulWidget {
  const BlackUserProfileScreen({super.key});

  @override
  State<BlackUserProfileScreen> createState() => _UserProfileScreenState();
}

class _UserProfileScreenState extends State<BlackUserProfileScreen> {
