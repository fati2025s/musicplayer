    ...
    return Scaffold(
      ...
      body: playlists.isEmpty
        ...
        child: GridView.count(
          crossAxisCount: 2, // دو کادر در هر ردیف
          crossAxisSpacing: 10,
          mainAxisSpacing: 10,
            ...
            return GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => PlaylistDetail(name: playlists[index].name),
                  ),
                );
              },
              child: Container(
...
class PlaylistDetail extends StatelessWidget {
  ...
  const PlaylistDetail({Key? key, required this.name}) : super(key: key);
