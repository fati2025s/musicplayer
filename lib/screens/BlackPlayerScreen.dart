...
class BlackPlayerScreen extends StatefulWidget {
  ...
  const BlackPlayerScreen({Key? key, required this.audioService}) : super(key: key);

  @override
  State<BlackPlayerScreen> createState() => _PlayerScreenState();
}

class _PlayerScreenState extends State<BlackPlayerScreen> {
